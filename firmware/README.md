...
This project, like the entire Nervous initiative, is licensed under the [MIT License](https://opensource.org/licenses/MIT). For more details, refer to the [License](LICENSE.md) file.

---

## Acknowledgments

The main contributor to this project is Bertrand Massot from INSA Lyon, CNRS, INL UMR 5270, Villeurbanne, France.
